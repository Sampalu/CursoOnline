namespace CursoOnline.Dominio.Base
{
    public static class Resource
    {
        ...
        public static string CargaHorariaInvalida = "Carga horária inválida";
        ...
        public static string ValorPagoMaiorQueValorDoCurso = "Valor pago na matricula não pode ser maior que valor do curso";
